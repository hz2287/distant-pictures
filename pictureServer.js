...
var dash = dash_button("44:65:0d:d9:b3:cf", null, null, 'all');
dash.on("detected", function() {
    ...
    console.log('making a making a picture at'+ imageName); // Second, the name is logged to the$

    //Third, the picture is  taken and saved to the `public/`` folder
    NodeWebcam.capture('public/'+imageName, opts, function( err, data ) {
    io.emit('newPicture',(imageName+'.jpg')); ///Lastly, the new name is send to the client web $
